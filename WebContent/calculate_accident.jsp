					...
					<div class="row">
						<div class="col-sm-8 window">
							<div class="card text-center">
								<div class="card-header product-header">意外傷害險-保費試算</div>
								<div class="card-block">
									<div class="form">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label"> <span
												class="oi oi-list" aria-hidden="true"></span>職業類別 <span
											...
											<div class="col-sm-3 form-check form-check-inline"
												...
												<input class="form-check-input" type="radio" name="years"
													id="y10" value="1" checked onchange=""> <label
													class="form-check-label" for="y10">內勤人員</label>
											</div>
											<div class="col-sm-3 form-check form-check-inline">
												<input class="form-check-input" type="radio" name="years"
													id="y20" value="2" onchange=""> <label
													class="form-check-label" for="y20">外勤人員</label>
											</div>
							...
							<div class="col-sm text-center" style="margin-top: 5%">
								<a href="applyAccident.jsp" class="btn btn-success"> <span
...
<!-- 計算意外傷害險保費專用js -->
<script src="vendor/js/calculateAccident.js"></script>
<!-- Alertify JavaScript -->
