...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
		<div class="container">
			<a class="navbar-brand" href="index.jsp">網路投保專區-定期壽險</a>
							...
							<div class="row">
								<div class="col-sm-8 window">
									<div class="card text-center">
										<div class="card-header apply-header">定期壽險-填寫投保內容</div>
										<div class="card-block">
											<form class="form" action="Life" method="post">
												...
												<div class="form-group row">
													...
													<div class="col-sm-2 form-check form-check-inline"
														...
														<input class="form-check-input" type="radio" name="years"
															id="y10" value="10"> <label
															class="form-check-label" for="y10">10年期</label>
													</div>
													<div class="form-check form-check-inline">
														<input class="form-check-input" type="radio" name="years"
															id="y20" value="20"> <label
