...
<jsp:useBean id="policyTour" class="beans.PolicyTour" scope="session" />
								...
								<table class="table table-hover table-bordered">
									<tbody>
										...
										<tr>
											...
											<td>${policyTour.insAmount}萬元</td>
										</tr>
										<tr>
											<th scope="row" class="tablenavO">旅遊地點</th>
											<td>${policyTour.location}</td>
										</tr>
										<tr>
											<th scope="row" class="tablenavE">保險期間</th>
											<td>${policyTour.period}</td>
										</tr>
										<tr>
											<th scope="row" class="tablenavO">保險費</th>
											<td>新台幣${policyTour.premium}元整</td>
										</tr>
									</tbody>
								</table>
							</div>
							<div class="col-sm text-center" style="margin-top: 5%">
								<a href="applyTour.jsp" class="btn btn-warning" style="float:left"> <span
									class="oi oi-action-undo" aria-hidden="true"></span>重新填寫
								</a>
								<a href="Underwriter?policy=tour" class="btn btn-success" style="float:right"> <span
									class="oi oi-circle-check" aria-hidden="true"></span>確定投保
								</a><br><br>
							</div>
						</div>
					</div>
