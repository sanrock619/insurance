								...
								<table class="table table-hover table-bordered">
									<tbody>
										...
										<tr>
											...
											<td>${policyLife.insAmount}萬元</td>
										</tr>
										<tr>
											<th scope="row" class="tablenavO">繳費年期</th>
											<td>${policyLife.years}年</td>
										</tr>
										<tr>
											<th scope="row" class="tablenavE">保險期間</th>
											<td>${policyLife.period}</td>
										</tr>
										<tr>
											<th scope="row" class="tablenavO">保險費</th>
											<td>新台幣${policyLife.premium}元整</td>
										</tr>
									</tbody>
								</table>
							</div>
							<div class="col-sm text-center" style="margin-top: 5%">
								<a href="applyLife.jsp" class="btn btn-warning" style="float:left"> <span
									class="oi oi-action-undo" aria-hidden="true"></span>重新填寫
								</a>
								<a href="Underwriter?policy=life" class="btn btn-success" style="float:right"> <span
